...
const RouteFe = ({courses, community}) => {
  const navigate = useNavigate();
  const courseFE = courses?.filter(item => item.category === "FE")
  return (
    <div className="row StudyPlan__wrap">
    <div className="col-9 col-xxl-8 col-xl-12">
      <div className="StudyPlan__title">
        <h1 className="StudyPlan__heading">Khóa học FrontEnd</h1>
...
export default getCourseHoc(RouteFe)